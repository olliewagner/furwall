...
private struct OnboardingView: View {
    ...
    private func openAccessibilitySettings() {
        // Register Furwall in the Accessibility list (so the user has a row to
        // toggle) without spawning the system "Accessibility Access" prompt.
        // The system prompt would appear behind our floating panel and stick
        // around even after the user grants — confusing two-dialog flow.
        // prompt:false still registers the process; only the dialog is
        // suppressed.
